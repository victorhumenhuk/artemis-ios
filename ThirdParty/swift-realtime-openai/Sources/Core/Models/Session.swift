...
@Codable public struct Session: Equatable, Hashable, Sendable {
	...
	/// The set of output modalities the model can respond with (GA: output_modalities).
	...
	public init(id: String? = nil, audio: Audio, instructions: String, maxResponseOutputTokens: MaxResponseOutputTokens? = nil, outputModalities: [Modality]? = nil, model: Model, prompt: Prompt? = nil, temperature: Double? = nil, toolChoice: Tool.Choice? = nil, tools: [Tool]? = nil) {
		self.id = id
		self.tools = tools
		self.model = model
		self.audio = audio
